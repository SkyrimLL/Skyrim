...
Event OnContainerChanged(ObjectReference akNewContainer, ObjectReference akOldContainer)
	...
	if ((akNewContainer != Game.GetPlayer()) && (IsActorValid == True)) && (akNewContainer != None) && (ContainerRace!=None)
		...
		StorageUtil.SetIntValue(akActor, "_SLMC_victimDateEnslaved", Utility.GetCurrentGameTime() As Int )
	...
	ElseIf (akNewContainer == Game.GetPlayer()) || (akNewContainer == None)
		...
		if (akOldContainer != None)
			...
			daysSinceEnslavement = (Utility.GetCurrentGameTime() - StorageUtil.GetIntValue(akActor, "_SLMC_victimDateEnslaved") ) as Int
