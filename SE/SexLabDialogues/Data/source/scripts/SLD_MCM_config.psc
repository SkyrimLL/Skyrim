...
event OnPageReset(string a_page)
	...
	_SaveOnRest = StorageUtil.GetIntValue( none , "_SLD_saveOnRest")
	...
	ElseIf (a_page == "Debug")
		...
		AddHeaderOption(" Rest Anywhere")
		AddToggleOptionST("STATE_SaveOnRest","Save on Rest Anywhere", _SaveOnRest	 as Float)
...
; AddToggleOptionST("STATE_SaveOnRest","Save on Rest Anywhere", _SaveOnRest	 as Float)
state STATE_SaveOnRest ; TOGGLE
	event OnSelectST()  
		_SaveOnRest = StorageUtil.GetIntValue( none , "_SLD_saveOnRest")
		_SaveOnRest  = Math.LogicalXor( 1, (_SaveOnRest  as Int) )
		SetToggleOptionValueST( _SaveOnRest )
		StorageUtil.SetIntValue( none , "_SLD_saveOnRest", _SaveOnRest as Int)
		ForcePageReset()
	endEvent
	...
	event OnHighlightST()
		SetInfoText("Rest Anywhere spell (sleep or meditation) triggers an auto-save.")
	endEvent
