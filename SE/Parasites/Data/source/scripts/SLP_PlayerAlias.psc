...
Event OnSleepStart(float afSleepStartTime, float afDesiredSleepEndTime)
	...
	; Clean up pheromones effects
	StorageUtil.SetIntValue(PlayerActor, "_SLP_iChaurusPheromoneON", 0)
	StorageUtil.SetIntValue(PlayerActor, "_SLP_iChaurusCharmON", 0)
 	StorageUtil.SetIntValue(PlayerActor, "_SLP_iSpiderPheromoneON", 0)
	StorageUtil.SetIntValue(PlayerActor, "_SLP_iSpiderCharmON", 0)
	fctParasites.clearSpiderFaction()
	fctParasites.clearChaurusFaction()
