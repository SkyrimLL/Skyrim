...
event OnPageReset(string a_page)
	...
	elseIf (a_page == "$SLH_pBodyChanges")
		...
		AddTextOption("$SLH_WEIGHT_MODIFIER_L1", "", OPTION_FLAG_DISABLED)
		AddTextOption("$SLH_WEIGHT_MODIFIER_L2", "", OPTION_FLAG_DISABLED)
		AddTextOption("$SLH_WEIGHT_MODIFIER_L3", "", OPTION_FLAG_DISABLED)
		AddTextOption("$SLH_WEIGHT_MODIFIER_L4", "", OPTION_FLAG_DISABLED)
		AddTextOption("$SLH_WEIGHT_MODIFIER_L5", "", OPTION_FLAG_DISABLED)
	...
	elseIf (a_page == "$SLH_pTriggers")
		...
		AddToggleOptionST("STATE_ENABLE_BODYMORPHS","$SLH_ENABLE_BODYMORPHS", StorageUtil.GetIntValue(none, "_SLH_BodyMorphsON") as Float)
	...
	elseIf (a_page == "$SLH_pCurses")
		...
		AddHeaderOption("SLH_hWINGS")
		if (StorageUtil.GetIntValue(PlayerActor, "_SLH_iSuccubusLevel") >=4)
			AddToggleOptionST("STATE_AUTO_REMOVE_WINGS","$SLH_AUTO_REMOVE_WINGS", _autoRemoveDragonWings as Float)
		else
			AddToggleOptionST("STATE_AUTO_REMOVE_WINGS","$SLH_AUTO_REMOVE_WINGS", _autoRemoveDragonWings as Float, OPTION_FLAG_DISABLED)
		endif

		if (StorageUtil.GetIntValue(none, "_SLP_isAnimatedDragonWings") ==  1) 
			AddTextOption("$SLH_ANIMATEDDRAGONWINGS_DETECTED", "", OPTION_FLAG_DISABLED)
		endif

		if (StorageUtil.GetIntValue(none, "_SLP_isRealFlying") ==  1) 
			AddTextOption("$SLH_REALFLYING_DETECTED", "", OPTION_FLAG_DISABLED)
		endif
	...
	elseIf (a_page == "$SLH_pDebug")
		...
		If (StorageUtil.GetIntValue(none, "_SLH_iHormonesSleepInit")==0)
			...
			AddTextOption("$SLH_HORMONES_IS_INACTIVE", "", OPTION_FLAG_DISABLED)
		Else
			AddTextOption("$SLH_HORMONES_IS_ACTIVE", "")
		Endif
