...
Quest Property DibellaInitiation  Auto  
Quest Property JoiningSisterhoodQuest  Auto  

Keyword Property DibellaHoodKeyword  Auto  
...
Form SisterHood = None
Keyword SisterHoodKeyword = None
...
Function _Maintenance()
	...
	SisterHood = StorageUtil.GetFormValue(none, "_SLSD_DibellaHood") as Armor
	SisterHoodKeyword = StorageUtil.GetFormValue(none, "_SLSD_DibellaHoodKeyword") as Keyword
...
Event OnItemAdded(Form akBaseItem, int aiItemCount, ObjectReference akItemReference, ObjectReference akSourceContainer)
	...
	if (SisterHoodKeyword == None)
		SisterHood = StorageUtil.GetFormValue(none, "_SLSD_DibellaHood") 
		SisterHoodKeyword = StorageUtil.GetFormValue(none, "_SLSD_DibellaHoodKeyword") as Keyword
	endif

	; Debug.Notification("Received: " + akBaseItem.GetFormID())
	; Debug.Notification("Sister hood: " + SisterHood.GetFormID() )
	; Debug.Notification("Initiation Stage 2: " + DibellaInitiation.GetStageDone(2) )
	; Debug.Notification("Initiation Stage 10: " + DibellaInitiation.GetStageDone(10) )

	if (akBaseItem == SisterHood) ; || akBaseItem.HasKeyword(SisterHoodKeyword)  
	  if akSourceContainer == Game.GetPlayer()
	    ; Debug.Notification("The player gave me " + aiItemCount + "x " + akBaseItem)
	  else
	    ; Debug.Notification("I found " + aiItemCount + "x " + akBaseItem )
		If (!JoiningSisterhoodQuest.GetStageDone(2)) &&  (!JoiningSisterhoodQuest.GetStageDone(10))
		    ; Debug.Notification("Triggering Initiation Stage 2" )
			JoiningSisterhoodQuest.SetStage(2) 
		EndIf
	  endIf
	endif
endEvent
