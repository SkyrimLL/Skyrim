...
Event OnSleepStart(float afSleepStartTime, float afDesiredSleepEndTime)
	...
	yearsCount = StorageUtil.GetIntValue(PlayerActor, "_FT_iPlayerYearsCount")
 	...
 	If (!bGrantStartPerks) && (baseAge>16)
 		...
 		iStartingPerks = (baseAge as Int) - 16
 		Game.AddPerkPoints( iStartingPerks )
 		Game.SetPlayerLevel( iStartingPerks / 2 )
		Debug.Trace("Reflect on what you have learned so far.\n[ "+iStartingPerks+" perk points assigned based on starting age. ] " )
		Debug.Messagebox("Reflect on what you have learned so far.\n[ "+iStartingPerks+" perk points assigned based on starting age. ] " )
 	endif
