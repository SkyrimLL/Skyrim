...
Armor Property DibellaHood  Auto  
...
;
	...
	; Register keyword and outfit for detection in main Sisterhood mod
	StorageUtil.SetFormValue(none, "_SLSD_DibellaHood",  DibellaHood)  
	StorageUtil.SetFormValue(none, "_SLSD_DibellaHoodKeyword",  DibellaHoodKeyword)  
