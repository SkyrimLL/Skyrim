...
Bool Function tryParasiteNextStage(Actor kActor, String sParasite)
 	...
 	If (kActor == PlayerActor)
		...
		; Disable if flareDelay is 0 - events are on pause
 		...
 		; ----------------------------------
 		; Block stages that are unsafe while player is busy
...
Function tryCharmSpider(Actor Target)
	...
	if fctUtils.checkIfSpider ( Target ) && (StorageUtil.GetIntValue(kPlayer, "_SLP_iSpiderCharmON") == 0) && (StorageUtil.GetIntValue(kPlayer, "_SLP_iSpiderPheromoneON") == 1)
...
Function tryCharmChaurus(Actor Target)
	...
	if fctUtils.checkIfChaurus ( Target ) && (StorageUtil.GetIntValue(kPlayer, "_SLP_iChaurusCharmON") == 0) && (StorageUtil.GetIntValue(kPlayer, "_SLP_iChaurusPheromoneON") == 1)
